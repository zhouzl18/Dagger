...
public class DbHelper extends SQLiteOpenHelper {
    ...
    protected User getUser(Long userId) throws Resources.NotFoundException, NullPointerException{
        ...
        try {
            ...
            if(cursor.getCount() > 0){
                ...
                throw new Resources.NotFoundException("User with id = " + userId + " is not exists");
            }
    ...
    protected Long insertUser(User user) throws Exception{
        try {
            ...
            values.put(USER_COLUMN_USER_NAME, user.getName());
            values.put(USER_COLUMN_USER_ADDRESS, user.getAddress());
